...
<body class="bg-slate-50 dark:bg-[#060b1d] transition-colors duration-300">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute -bottom-40 -left-40 w-96 h-96 bg-blue-500/10 rounded-full blur-[100px]"></div>
    </div>
    ...
    <main class="relative z-10 min-h-screen flex flex-col items-center py-20 px-4">
        <div class="max-w-4xl w-full">
            ...
            <div class="glass rounded-[3rem] p-10 md:p-16 shadow-2xl overflow-hidden relative">
                ...
                <div class="mt-16 pt-10 border-t border-slate-100 dark:border-slate-800 flex flex-col md:flex-row items-center justify-center gap-8">
