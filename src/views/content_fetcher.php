...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $apiKeys = [
        "AIzaSyBtw1_OedwA9ojmxeG42w9DlrNmnVdjuQQ"
    ];
    shuffle($apiKeys);
    ...
    foreach ($apiKeys as $key) {
        ...
        foreach ($attempts as $att) {
            ...
            $payload = json_encode([
                "contents" => [["parts"=>[["text"=>"Kamu adalah Gemini, asisten LMS yang cerdas dan ramah. Pakai Bahasa Indonesia. Bantu pengguna mengerti sistem LMS dan materi pelajaran dengan penjelasan yang mudah. Pertanyaan: ".$msg]]]],
