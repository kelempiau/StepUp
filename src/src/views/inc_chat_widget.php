...
<div id="aiChatBubble" class="fixed bottom-6 right-6 z-[9990] animate__animated animate__bounceIn">
    <button onclick="toggleChatPopup()" class="w-16 h-16 bg-gradient-to-tr from-blue-600 to-indigo-600 rounded-full shadow-2xl shadow-blue-500/40 text-white flex items-center justify-center text-3xl hover:scale-110 transition-transform duration-300 relative group">
...
<div id="aiChatPopup" class="fixed bottom-24 right-6 w-[90vw] md:w-[400px] h-[600px] max-h-[80vh] bg-white dark:bg-slate-900 rounded-[2rem] shadow-2xl border border-slate-100 dark:border-slate-800 z-[9999] hidden flex flex-col overflow-hidden animate__animated animate__fadeInUp origin-bottom-right">
    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-600 p-6 flex justify-between items-center shrink-0">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h3 class="font-black text-white text-lg leading-none">Asisten Belajar</h3>
                <p class="text-blue-100 text-xs font-medium mt-1">Siap membantu 24/7</p>
            </div>
        </div>
        ...
        <div class="flex items-start space-x-3">
            ...
            <div class="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 p-4 rounded-2xl rounded-tl-none shadow-sm max-w-[85%]">
                <p class="text-sm text-slate-700 dark:text-slate-300 leading-relaxed">
                    Halo! 👋 Saya Asisten Belajar AI kamu. <br><br>
                    Ada materi pelajaran yang kurang jelas? Atau butuh tips belajar? Tanyakan saja disini ya!
                </p>
            </div>
        </div>
    </div>
...
<script>
    const SYSTEM_INSTRUCTION = "Kamu adalah Asisten Belajar untuk siswa kelas 12. Jawablah pertanyaan terkait materi pelajaran (Matematika, PKN, Seni Budaya) dengan ramah, suportif, dan mudah dimengerti. Gunakan Bahasa Indonesia. Jawaban singkat dan jelas.";
