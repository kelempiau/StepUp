                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div class="bg-white dark:bg-[#0a1128] p-8 rounded-[2.5rem] border border-blue-50 dark:border-blue-900/20 shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/5">
                                ...
                                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Rata-rata Skor Kuis</p>
                                <h4 class="text-3xl font-black text-slate-800 dark:text-white"><?php echo $avg_quiz_score; ?></h4>
                            </div>
                            <div class="bg-white dark:bg-[#0a1128] p-8 rounded-[2.5rem] border border-blue-50 dark:border-blue-900/20 shadow-sm transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/5">
