...
<body class="min-h-screen bg-slate-50 flex items-center justify-center p-4">
    ...
    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div class="absolute -bottom-40 -left-40 w-96 h-96 bg-indigo-200/30 rounded-full blur-3xl"></div>
    </div>
    ...
    <div class="w-full max-w-md relative z-[20] card pointer-events-auto">
        ...
        <div class="bg-white rounded-[3.5rem] shadow-2xl border border-slate-100 p-10 md:p-12">
            ...
            <form method="POST" class="space-y-5" autocomplete="off" novalidate>
                ...
                <button type="submit" class="w-full py-5 bg-blue-600 hover:bg-blue-700 text-white font-black rounded-2xl transition-all shadow-xl shadow-blue-500/30 hover:scale-[1.02] active:scale-95 mt-4 uppercase tracking-widest text-xs">
